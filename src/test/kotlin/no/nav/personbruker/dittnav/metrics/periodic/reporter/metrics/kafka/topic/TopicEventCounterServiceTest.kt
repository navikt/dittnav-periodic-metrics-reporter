...
internal class TopicEventCounterServiceTest {
    ...
    internal fun `Should handle exceptions and rethrow as internal exception`() {
        ...
        coEvery { beskjedCountConsumer.poll(any<Duration>()) } throws simulatedException
        coEvery { innboksCountConsumer.poll(any<Duration>()) } throws simulatedException
        coEvery { oppgaveCountConsumer.poll(any<Duration>()) } throws simulatedException
        coEvery { doneCountConsumer.poll(any<Duration>()) } throws simulatedException
